      ...
      <div className="mx-auto flex max-w-4xl items-center justify-between px-3 py-2.5 sm:px-4 sm:py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-xs text-gray-500 leading-tight">Mandaue City</p>
          </div>
        </div>
        <nav className="flex gap-0.5 rounded-xl bg-gray-100 p-0.5 sm:p-1 sm:gap-1">
          <button
            onClick={() => onViewChange('form')}
            className={`flex items-center gap-1 sm:gap-1.5 rounded-lg px-2.5 py-2.5 sm:px-3.5 text-xs sm:text-sm font-medium transition-all min-h-[44px] ${
              currentView === 'form'
